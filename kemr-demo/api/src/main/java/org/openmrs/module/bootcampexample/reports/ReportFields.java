package org.openmrs.module.bootcampexample.reports;

import org.openmrs.PatientIdentifierType;
import org.openmrs.module.bootcampexample.calculation.AliveCalculation;
import org.openmrs.module.bootcampexample.calculation.EntryPointCalculation;
 ...
 */
@Component
@Builds("bootcampexample.common.report.bootcamp1")
public class ReportFields extends CalculationReportBuilder {
    ...
    protected void addColumns(CohortReportDescriptor report, PatientDataSetDefinition dsd){
        ...
        dsd.addColumn("Entry Point", new CalculationDataDefinition("Entry Point", new EntryPointCalculation()), "", new CalculationResultConverter());
