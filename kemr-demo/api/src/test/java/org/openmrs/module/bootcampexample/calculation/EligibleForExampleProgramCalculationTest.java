...
import org.openmrs.module.bootcampexample.metadata.ExampleMetadata;
...
/**
 * Tests for {@link EligibleForVmccProgramCalculation}
 */
public class EligibleForExampleProgramCalculationTest extends BaseModuleContextSensitiveTest {
	...
	public void evaluate() {
		...
		CalculationResultMap resultMap = Context.getService(PatientCalculationService.class).evaluate(ptIds, new EligibleForVmccProgramCalculation());
